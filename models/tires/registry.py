...
import numpy as np
# from models.tires.LinearTireModel import *
# from models.tires.SimplifiedPacejkaTireModel import *

from .LinearTireModel import LinearTireModel, LinearTireParams
from .SimplifiedPacejkaTireModel import SimplifiedPacejkaTireModel, SimplifiedPacejkaTireParams
...
TIRE_MODEL_REGISTRY = {
    LinearTireParams: LinearTireModel,
    SimplifiedPacejkaTireParams: SimplifiedPacejkaTireModel,
}