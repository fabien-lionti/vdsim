#!/usr/bin/env python3
"""
Script unifié pour générer toutes les figures du rapport LTR prediction.

Figures générées:
  1. Tableau comparatif complet (4 modèles × 4 configs × 3 horizons)
  2. Matrices de confusion 4×4 (D1/D2/D3/D4 × MLP/LSTM/PatchTST/XGBoost)
  3. Courbes de régression 4×4
  4. Comparaison recall par modèle
  5. Prédictions sur trajectoires (3 traj × 4 modèles)
  6. Détail prédiction sur une trajectoire
"""
